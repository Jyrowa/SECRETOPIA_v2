...
import { getDatabase, ref, set, update, onValue, get, push, remove } from "https://www.gstatic.com/firebasejs/11.4.0/firebase-database.js";
...
export { app, db, getDatabase, ref, set, update, onValue, get, push, remove };